...
if (isset($_SESSION['aluno_id'])) {
    ...
    exit;  // Sai do script, pois não faz sentido continuar sem um aluno logado
}

if (isset($_GET['materia_id'])) {
    $materia_id = $_GET['materia_id'];

    // Consulta para pegar a sala do aluno, usando prepared statement para prevenir SQL Injection
